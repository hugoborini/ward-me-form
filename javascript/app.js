...
for (let i = 0; i < $form.length; i++){
    $form[i].addEventListener("click", ()=>{
        if ($form[i].value === "non"){
            ...
            input_gamechoice.innerHTML = `<select class='form__select game_choice' id="game" name="type_game" >
        ...
        d'heures jouez-vous par semaine aux jeux vidéo (mobile inclus)"></input>`
